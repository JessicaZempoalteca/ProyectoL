...
<body>
    ...
    <form action="{{ route('grupos.update', $grupo->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="semestre" id="semestre" class="form-control" value="{{ old('semestre', $grupo->semestre) }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="grupo" id="grupo" class="form-control" value="{{ old('grupo', $grupo->grupo) }}">
            @if ($errors->has('grupo'))
